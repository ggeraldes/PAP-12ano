...
<html>
	<head>
		<title>Status Treinador Sub-23 | Site oficial AAC-OAF</title>
		<meta charset="utf-8" />
		<html lang="pt">
	...
	<body>
        ...
        $res=mysqli_query($mysqli, "select * from sub23t where id= $id");
   ...
   <?php if(isset($_POST["editar"])){
        ...
        if($fnm==""){
            ...
            $dst="./editor/equipaSub23/bannerT/".$tm.$fnm;
		    $dst1="bannerT/".$tm.$fnm;
		    move_uploaded_file($_FILES["foto"]["tmp_name"], $dst); 
            $sql = "update sub23t set banner= '$dst1'  where id=$id ";
