...
<html>
	<head>
		<title>Status Jogador Sub-23 | Site oficial AAC-OAF</title>
		<meta charset="utf-8" />
		<html lang="pt">
	...
	<body>
        ...
        $res=mysqli_query($mysqli, "select * from sub23j where numero= $numero");
    ...
    ?>
        ...
        <!-- Banner -->
			<style>
				#banner{
					background-image:url("editor/equipaSub23/<?php echo $banner; ?>");
   ...
   <?php if(isset($_POST["editar"])){
        ...
        if($fnm==""){
            ...
            $dst="./editor/equipaSub23/bannerJ/".$tm.$fnm;
		    $dst1="bannerJ/".$tm.$fnm;
		    move_uploaded_file($_FILES["foto"]["tmp_name"], $dst); 
            $sql = "update sub23j set banner= '$dst1'  where id=$id ";
            mysqli_query($mysqli, $sql);
        }

        ?>
		<script type="text/javascript">
		window.location="status23?numero=<?php echo $row["numero"]; ?>";
